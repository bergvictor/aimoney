...
INSERT INTO opportunities (slug, title, one_liner, category, status, value, effort, confidence, fit, score, est_monthly_low, est_monthly_high, time_to_first_dollar, capital_needed, skills_needed, source, source_url, notes) VALUES
...
-- Briefs for the top 4.
INSERT INTO briefs (opportunity_id, version, summary, what_works, numbers_json, risks, first_steps, sources_json, author) VALUES
((SELECT id FROM opportunities WHERE slug='ai-ugc-ads-service'), 1,
...
'seed'),
((SELECT id FROM opportunities WHERE slug='ai-freelance-outcomes'), 1,
...
'seed'),
((SELECT id FROM opportunities WHERE slug='ai-chatbot-integration'), 1,
...
'seed'),
((SELECT id FROM opportunities WHERE slug='ai-automation-agency'), 1,
...
-- Starter experiment for the top pick.
INSERT INTO experiments (opportunity_id, name, hypothesis, status, budget_cap, spent, metric, target) VALUES
((SELECT id FROM opportunities WHERE slug='ai-ugc-ads-service'),
